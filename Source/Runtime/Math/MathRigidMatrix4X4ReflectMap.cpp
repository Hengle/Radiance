// MathRigidMatrix4X4ReflectMap.cpp
...
#define PRIVATE_REFLECT_MATRIX4X4(_name, _namespace, _type, _valueType)\
	RADREFLECT_BEGIN_CLASS_DESTRUCTOR_NAMESPACE(_name, _namespace, _type, RigidMatrix4X4)\
	...
	RADREFLECT_BEGIN_STATICMETHOD(_namespace::_type)\
		RADREFLECT_ARG("scale", const _valueType&)\
	...
	RADREFLECT_CONSTMETHOD(_namespace::RigidMatrix4X4<_valueType>, Inverse)\
...
PRIVATE_REFLECT_MATRIX4X4("math::RigidMatrix4X4F", math, RigidMatrix4X4F, float)
PRIVATE_REFLECT_MATRIX4X4("math::RigidMatrix4X4D", math, RigidMatrix4X4D, double)
