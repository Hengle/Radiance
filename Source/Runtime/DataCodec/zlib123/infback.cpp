...
/*
   _this code is largely copied from inflate.c.  Normally either infback.o or
...
/*
   ...
   thereafter.  _this reduces the size of the code by about 2K bytes, in
   exchange for a little execution time.  However, BUILDFIXED should not be
   used for threaded applications, since the rewriting of the tables and virgin
   may not be thread-safe.
 */
static void fixedtables(inflate_state FAR *state)
{
#ifdef BUILDFIXED
    static int virgin = 1;
...
/*
   ...
   inflateBack() call.  _this parameter can be a structure that provides the
