...
//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::LWRedBlackNodeTree()
//////////////////////////////////////////////////////////////////////////////////////////
...
{
	RAD_ASSERT_MSG(m_magicID == MAGIC_ID, STDPTR_DEBUG_ERROR_BADMEMORY);
	RAD_ASSERT_MSG(IsEmpty(), "Attempting to destruct an active LWRedBlackTree!");
}


//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::Clear()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::Clear()
{
	RAD_ASSERT_MSG(m_magicID == MAGIC_ID, STDPTR_DEBUG_ERROR_BADMEMORY);
...
//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::LeftRotate()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::LeftRotate(Node* x)
{
	RAD_ASSERT(x);
	...
	RAD_ASSERT_MSG(!m_NIL->m_red,"LWRedBlackNodeTree::LeftRotate :: sentinel is red!");
	RAD_ASSERT_MSG(!m_root->m_red,"LWRedBlackNodeTree::LeftRotate :: root is red!");
}


//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::RightRotate()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::RightRotate(Node* y)
{
	RAD_ASSERT(y);
	...
	RAD_ASSERT_MSG(!m_NIL->m_red,"LWRedBlackNodeTree::RightRotate :: sentinel is red!");
	RAD_ASSERT_MSG(!m_root->m_red,"LWRedBlackNodeTree::RightRotate :: root is red!");
}


//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::PrivateInsert()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::PrivateInsert(Node * x)
{
	RAD_ASSERT(x);
	RAD_ASSERT(x->m_magicID == Node::MAGIC_ID);
	...
	RAD_ASSERT_MSG(!m_NIL->m_red,"LWRedBlackNodeTree::Insert :: sentinel is red!");
	RAD_ASSERT_MSG(!m_root->m_red,"LWRedBlackNodeTree::Insert :: root is red!");
}


//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::RemoveFixUp()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::RemoveFixUp(Node* x)
{
	RAD_ASSERT(x);
	RAD_ASSERT(x->m_magicID == Node::MAGIC_ID);
	...
	RAD_ASSERT_MSG(!m_NIL->m_red,"LWRedBlackNodeTree::RemoveFixUp :: sentinel is red!");
	RAD_ASSERT_MSG(!m_root->m_red,"LWRedBlackNodeTree::RemoveFixUp :: root is red!");
}


//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::Remove()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::Remove(Node * z)
{
	RAD_ASSERT(z);
	...
	RAD_ASSERT_MSG(!m_NIL->m_red,"LWRedBlackNodeTree::Remove :: sentinel is red!");
	RAD_ASSERT_MSG(!m_root->m_red,"LWRedBlackNodeTree::Remove :: root is red!");
}


//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::Successor()
//////////////////////////////////////////////////////////////////////////////////////////

LWRedBlackNodeTree::Node* LWRedBlackNodeTree::Successor(const Node * x) const
{
	RAD_ASSERT(x);
	RAD_ASSERT(x->m_magicID == Node::MAGIC_ID);
	RAD_ASSERT(x->m_inTree == this);
...
//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::Predecessor()
//////////////////////////////////////////////////////////////////////////////////////////

LWRedBlackNodeTree::Node* LWRedBlackNodeTree::Predecessor(const Node * x) const
{
	RAD_ASSERT(x);
	RAD_ASSERT(x->m_magicID == Node::MAGIC_ID);
	RAD_ASSERT(x->m_inTree == this);
...
//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::Traverse()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::Traverse(TraversalType type,TraverseProc callback,void* userData) const
{
	RAD_ASSERT_MSG(m_magicID == MAGIC_ID, STDPTR_DEBUG_ERROR_BADMEMORY);
...
//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::PrivateTraversePreorder()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::PrivateTraversePreorder(TraverseProc callback,Node* n,void* userData) const
{
	RAD_ASSERT(n);
...
//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::PrivateTraverseInorder()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::PrivateTraverseInorder(TraverseProc callback,Node* n,void* userData) const
{
	RAD_ASSERT(n);
	RAD_ASSERT(n->m_magicID == Node::MAGIC_ID);
	RAD_ASSERT(n->m_inTree == this);
...
//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::PrivateTraversePostorder()
//////////////////////////////////////////////////////////////////////////////////////////

void LWRedBlackNodeTree::PrivateTraversePostorder(TraverseProc callback,Node* n,void* userData) const
{
	RAD_ASSERT(n);
	RAD_ASSERT(n->m_magicID == Node::MAGIC_ID);
	RAD_ASSERT(n->m_inTree == this);
...
//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::First()
//////////////////////////////////////////////////////////////////////////////////////////

LWRedBlackNodeTree::Node* LWRedBlackNodeTree::First() const
{
	RAD_ASSERT_MSG(m_magicID == MAGIC_ID, STDPTR_DEBUG_ERROR_BADMEMORY);
...
//////////////////////////////////////////////////////////////////////////////////////////
// LWRedBlackNodeTree::Last()
//////////////////////////////////////////////////////////////////////////////////////////

LWRedBlackNodeTree::Node* LWRedBlackNodeTree::Last() const
{
	RAD_ASSERT_MSG(m_magicID == MAGIC_ID, STDPTR_DEBUG_ERROR_BADMEMORY);
