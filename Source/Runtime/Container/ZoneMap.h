...
{
	typedef pool_allocator<typename std::pair<const K, T>, _Zone, 8, 0xffffffff, kDefaultAlignment, MemoryPool> pool_type;
...
{
	typedef pool_allocator<std::pair<const K, T>, _Zone, 8, 0xffffffff, kDefaultAlignment, MemoryPool> pool_type;
