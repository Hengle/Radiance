...
{
	typedef pool_allocator<typename std::pair<const K, T>, _Zone, 16, 0x7fffffff, MemoryPool> pool_type;
...
{
	typedef pool_allocator<std::pair<const K, T>, _Zone, 16, 0x7fffffff, MemoryPool> pool_type;
