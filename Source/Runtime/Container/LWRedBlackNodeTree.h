// LWRedBlackNodeTree.h
// A RedBlack Tree with no vtable in the nodes.
...
//////////////////////////////////////////////////////////////////////////////////////////
//
// A lightweight red black tree that requires the user to derive from a base node
// class.
//
// Important NOTE: LWRedBlackNodeTree does not make a copy of objects that are inserted! This
// is for performance purposes.
//
//////////////////////////////////////////////////////////////////////////////////////////

class RADRT_CLASS LWRedBlackNodeTree
{
public:
	...
	private:
		...
		friend class LWRedBlackNodeTree;
	};
	...
	typedef void (*TraverseProc)(const LWRedBlackNodeTree* tree,const Node* n,void* userData);
...
protected:
	...
	LWRedBlackNodeTree(const LWRedBlackNodeTree&);
	LWRedBlackNodeTree& operator = (const LWRedBlackNodeTree&);
...
#include "../PopPack.h"
#include "LWRedBlackNodeTree.inl"
