...
#include "../../DataCodec/zlib123/zlib_original.h"
#endif
...
/* These were added in libpng-1.0.2 */
   ...
   data_codec::zlib::z_stream zstream;          /* pointer to decompression structure (below) */
...
#undef png_info_init
#define png_info_init(png_ptr, info_ptr) png_info_init_3(png_ptr, &info_ptr,\
    png_sizeof(png_info));
#endif

extern PNG_EXPORT(void,png_info_init_3) PNGARG((png_structp png_ptr, png_infopp info_ptr,
...
extern void png_read_destroy PNGARG((png_structp png_ptr, png_infopp info_ptr,
