...
class RADENG_CLASS D_VtModel : public D_Asset {
public:
	typedef boost::shared_ptr<D_VtModel> Ref;

	static Ref New(const r::VtMesh::Ref &mesh);

	RAD_DECLARE_READONLY_PROPERTY(D_VtModel, mesh, const r::VtMesh::Ref&);
...
protected:
	...
	D_VtModel(const r::VtMesh::Ref &mesh);
