...
template<>
struct hash<tools::box_bsp::Vec3>
{
	size_t operator() (const tools::box_bsp::Vec3 &v) const
	{
		return tools::box_bsp::HashVec(v);
	}
};

template<>
struct hash<tools::box_bsp::Vec4>
{
	size_t operator() (const tools::box_bsp::Vec4 &v) const
	{
		return tools::box_bsp::HashVec(v);
	}
};
...
template<>
inline size_t hash_value(const tools::box_bsp::Vec3 &v)
{
	return tools::box_bsp::HashVec(v);
}

template<>
inline size_t hash_value(const tools::box_bsp::Vec4 &v)
{
	return tools::box_bsp::HashVec(v);
}
