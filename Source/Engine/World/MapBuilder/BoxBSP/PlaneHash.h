...
{
public:
	typedef zone_vector< ::tools::box_bsp::Plane, ZToolsT>::type PlaneVec;
	...
	int FindPlaneNum(const ::tools::box_bsp::Plane &p)
	{
		::tools::box_bsp::Plane z = p;
		Clamp(z);
	...
	const ::tools::box_bsp::Plane &Plane(int num) const
	{
		return m_planes[num];
	}
...
private:
	...
	void Clamp(::tools::box_bsp::Plane &p)
	{
...
#define PLANE_DIST_WELD   ValueType(0.00199999999999)
	...
	bool PlaneEqual(const ::tools::box_bsp::Plane &a, const ::tools::box_bsp::Plane &b)
	{
